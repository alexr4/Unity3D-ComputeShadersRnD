...
public class T03CSController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ComputeBuffer buffer = new ComputeBuffer(8, sizeof(int)); //5 * 5 Groups of 2Kernel of 8 * 8
        ...
        cs.SetInt("multiple", 5); //Bind value to shader
        cs.Dispatch(kernel, 5, 5, 1); //Execute the kernel and defines the numpber of groupe. Hardware limit is 1024 and you need to use group for more datas

        int[] data = new int[8];//Create an array to retreive the data 
